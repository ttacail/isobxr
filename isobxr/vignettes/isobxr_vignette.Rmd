...
designed to perform and explore stable isotope box
...
and sweep the space of parameters in both static and dynamic modes.
...
The user is also invited to download the [reference templates](https://ttacail.github.io/source/demos/0_excel_templates.zip) for all input and master excel files described in this vignette, as well as download [the demonstration files input and master excel files](https://ttacail.github.io/source/demos/1_ABCD.zip) (see [Getting started 1](https://ttacail.github.io/isobxr/articles/Demo_ABCD.html) and [Getting started 2](https://ttacail.github.io/isobxr/articles/Demo_ABCD_composite.html)).
