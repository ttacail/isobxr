...
The [isobxr](https://ttacail.github.io/isobxr_web/) package is a set of R tools designed to perform and explore stable isotope box
...
The isobxr package (1.0.0) was first released on September 2nd, 2021, on the [CRAN](https://cran.r-project.org/) (Comprehensive R Archive Network) 
and can be found on its [isobxr CRAN page](https://cran.r-project.org/web/packages/isobxr/index.html). 
