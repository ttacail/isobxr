...
The outputs of the `sweep_steady` can be plotted using the `runShinyPlots` function. 

The `runShinyPlots` function launches an interactive html app allowing to edit and export graphical representation of the model runs. 
