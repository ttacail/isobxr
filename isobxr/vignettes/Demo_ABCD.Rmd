...
3. [Download the ABCD demo zip file](https://ttacail.github.io/source/demos/1_ABC_tutorial.zip).
...
```{r eval=FALSE}
workingdir <- "/Users/username/Documents/isobxr/demos/1_ABC_tutorial/"
```

or set it as a working directory, for instance:

```{r eval=FALSE}
setwd("/Users/username/Documents/isobxr/demos/1_ABC_tutorial")
```
